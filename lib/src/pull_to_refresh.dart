...
class PullToRefresh extends StatefulWidget {
  ...
  /// The widget below this widget in the tree.
  ///
  /// The indicator will appear on complete loading.
  ///
  final Widget onComplete;

  /// The widget below this widget in the tree.
  ///
  /// The indicator will appear on fail loading.
  ///
  final Widget onFail;
...
class PullToRefreshState extends State<PullToRefresh>
  ...
  /// show widget on complete
  ProgressStatus _progressStatus = ProgressStatus.loading;

  Widget? indicaterWidget;
  ...
  Future<void> _dismiss(PullToRefreshMode newMode) async {
    ...
    switch (_mode) {
      case PullToRefreshMode.done:
        ...
        //initial value of controller is 1.0 (indicator will move from top to bottom
  ...
  void _show() {
    ...
    indicaterWidget = widget.onLoading;
          ...
          builder: (BuildContext buildContext, Widget? child) {
            return ClipPath(
              ...
              child: Container(
                ...
                child:_mode == PullToRefreshMode.drag
                    ? widget.pullIndecator ?? Row(
                ...
                _progressStatus == ProgressStatus.loading?
                  Row(
                    ...
                    children:[
                      ...
                      SizedBox(width: 5,),
                      indicaterWidget != null ?
                        Opacity(
                            opacity:  getIndicaterOpcity(height) > 0 ? 1: 0,
                             child:indicaterWidget ?? const Text("Loading..")
                         )
                        :const SizedBox()
                  ...
                  :_progressStatus == ProgressStatus.completed?
                    Opacity(
                      ...
                      child: Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children:[
                          indicaterWidget ?? const Text("Succeed")
                    ...
                    :Opacity(
                      ...
                      child:Row(
                        ...
                        mainAxisAlignment: MainAxisAlignment.center,
                        children:[
                          indicaterWidget ?? const Text("Failed")
  ...
  double getIndicaterOpcity(double height){
   ...
   double progressCircleRadius= (_ringOpacityAnimation.value != 0.0)
       ? (height * 2 / 10) * _ringRadiusAnimation.value //20.0
       : 0.0;

   double containerOpcity =  2 * max(progressCircleRadius, innerCircleRadius);

   return containerOpcity;
